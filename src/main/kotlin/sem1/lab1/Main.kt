...
private fun lab1_1(matrix: Matrix) {
	val lu = SLAU(matrix).luDecomposition()

	println("\nLower matrix:")
	println(lu.first.toString())

	println("\nUpper matrix:")
	println(lu.second.toString())

	println("\nDeterminant of sem1.lab1.SLAU: ${matrix.det}")

	println("\nReverse sem1.lab1.SLAU:")
	println(matrix.reverse().toString())

}

private fun lab1_2(matrix: Matrix) {
...
private fun lab1_3(matrix: Matrix, epsilon: Double) {
...
private fun lab1_4(matrix: Matrix, epsilon: Double) {

	val answer = SLAU(matrix).rotationMethod(epsilon)
	println("\nOutput matrix:")
	println(answer.first.toString())
	println("\nAll x:")
	println(answer.second[0])
}

private fun lab1_5(matrix: Matrix, epsilon: Double) {
